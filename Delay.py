...
Both assume a standard rental of 24 hours, a median rental rate of 119 $ and a rate by the minute with no penalty for a late checkout.""")
...
A discussion with the product team would be needed to determine whether or not there should be a margin without penalty, to account for delays due to traffic or other unforeseen circumstances and avoid frustrating customers.
This would be a good first step to mitigate the impact of late arrivals on the business and would also help customers who are inconvenienced by late arrivals.
